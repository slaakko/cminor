...
int main(int argc, const char** argv)
{
    try
    {
        ...
        std::string xmlFileName = (boost::filesystem::path(cminor_root) / boost::filesystem::path("unicode") / boost::filesystem::path("ucd.all.flat.xml")).generic_string();
