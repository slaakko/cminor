...
Machine::Machine() : rootInst(*this, "<root_instruction>")
{
    //  arithmetic unary operators:
    //  ---------------------------

    //  unary plus:
    rootInst.SetInst(0x00, new UnaryOpInst<int8_t, std::identity<int8_t>>("uplussb"));
    rootInst.SetInst(0x01, new UnaryOpInst<uint8_t, std::identity<uint8_t>>("uplusby"));
    rootInst.SetInst(0x02, new UnaryOpInst<int16_t, std::identity<int16_t>>("uplussh"));
    rootInst.SetInst(0x03, new UnaryOpInst<uint16_t, std::identity<uint16_t>>("uplusus"));
    rootInst.SetInst(0x04, new UnaryOpInst<int32_t, std::identity<int32_t>>("uplusin"));
    rootInst.SetInst(0x05, new UnaryOpInst<uint32_t, std::identity<uint32_t>>("uplusui"));
    rootInst.SetInst(0x06, new UnaryOpInst<int64_t, std::identity<int64_t>>("upluslo"));
    rootInst.SetInst(0x07, new UnaryOpInst<uint64_t, std::identity<uint64_t>>("uplusul"));
    rootInst.SetInst(0x08, new UnaryOpInst<float, std::identity<float>>("uplusfl"));
    rootInst.SetInst(0x09, new UnaryOpInst<double, std::identity<double>>("uplusdo"));

    //  unary minus:
    rootInst.SetInst(0x0A, new UnaryOpInst<int8_t, std::negate<int8_t>>("negsb"));
    rootInst.SetInst(0x0B, new UnaryOpInst<uint8_t, std::negate<uint8_t>>("negby"));
    rootInst.SetInst(0x0C, new UnaryOpInst<int16_t, std::negate<int16_t>>("negsh"));
    rootInst.SetInst(0x0D, new UnaryOpInst<uint16_t, std::negate<uint16_t>>("negus"));
    rootInst.SetInst(0x0E, new UnaryOpInst<int32_t, std::negate<int32_t>>("negin"));
    rootInst.SetInst(0x0F, new UnaryOpInst<uint32_t, std::negate<uint32_t>>("negui"));
    rootInst.SetInst(0x10, new UnaryOpInst<int64_t, std::negate<int64_t>>("neglo"));
    rootInst.SetInst(0x11, new UnaryOpInst<uint64_t, std::negate<uint64_t>>("negul"));
    rootInst.SetInst(0x12, new UnaryOpInst<float, std::negate<float>>("negfl"));
    rootInst.SetInst(0x13, new UnaryOpInst<double, std::negate<double>>("negdo"));

    //  bitwise complement:
    rootInst.SetInst(0x14, new UnaryOpInst<int8_t, std::bit_not<int8_t>>("cplsb"));
    rootInst.SetInst(0x15, new UnaryOpInst<uint8_t, std::bit_not<uint8_t>>("cplby"));
    rootInst.SetInst(0x16, new UnaryOpInst<int16_t, std::bit_not<int16_t>>("cplsh"));
    rootInst.SetInst(0x17, new UnaryOpInst<uint16_t, std::bit_not<uint16_t>>("cplus"));
    rootInst.SetInst(0x18, new UnaryOpInst<int32_t, std::bit_not<int32_t>>("cplin"));
    rootInst.SetInst(0x19, new UnaryOpInst<uint32_t, std::bit_not<uint32_t>>("cplui"));
    rootInst.SetInst(0x1A, new UnaryOpInst<int64_t, std::bit_not<int64_t>>("cpllo"));
    rootInst.SetInst(0x1B, new UnaryOpInst<uint64_t, std::bit_not<uint64_t>>("cplul"));

    // arithmetic binary operators:
    // ----------------------------

    //  add:
    rootInst.SetInst(0x1C, new BinaryOpInst<int8_t, std::plus<int8_t>>("addsb"));
    rootInst.SetInst(0x1D, new BinaryOpInst<uint8_t, std::plus<uint8_t>>("addby"));
    rootInst.SetInst(0x1E, new BinaryOpInst<int16_t, std::plus<int16_t>>("addsh"));
    rootInst.SetInst(0x1F, new BinaryOpInst<uint16_t, std::plus<uint16_t>>("addus"));
    rootInst.SetInst(0x20, new BinaryOpInst<int32_t, std::plus<int32_t>>("addin"));
    rootInst.SetInst(0x21, new BinaryOpInst<uint32_t, std::plus<uint32_t>>("addui"));
    rootInst.SetInst(0x22, new BinaryOpInst<int64_t, std::plus<int64_t>>("addlo"));
    rootInst.SetInst(0x23, new BinaryOpInst<uint64_t, std::plus<uint64_t>>("addul"));
    rootInst.SetInst(0x24, new BinaryOpInst<float, std::plus<float>>("addfl"));
    rootInst.SetInst(0x25, new BinaryOpInst<double, std::plus<double>>("adddo"));

    //  subtract:
    rootInst.SetInst(0x26, new BinaryOpInst<int8_t, std::minus<int8_t>>("subsb"));
    rootInst.SetInst(0x27, new BinaryOpInst<uint8_t, std::minus<uint8_t>>("subby"));
    rootInst.SetInst(0x28, new BinaryOpInst<int16_t, std::minus<int16_t>>("subsh"));
    rootInst.SetInst(0x29, new BinaryOpInst<uint16_t, std::minus<uint16_t>>("subus"));
    rootInst.SetInst(0x2A, new BinaryOpInst<int32_t, std::minus<int32_t>>("subin"));
    rootInst.SetInst(0x2B, new BinaryOpInst<uint32_t, std::minus<uint32_t>>("subui"));
    rootInst.SetInst(0x2C, new BinaryOpInst<int64_t, std::minus<int64_t>>("sublo"));
    rootInst.SetInst(0x2D, new BinaryOpInst<uint64_t, std::minus<uint64_t>>("subul"));
    rootInst.SetInst(0x2E, new BinaryOpInst<float, std::minus<float>>("subfl"));
    rootInst.SetInst(0x2F, new BinaryOpInst<double, std::minus<double>>("subdo"));

    //  multiply:
    rootInst.SetInst(0x30, new BinaryOpInst<int8_t, std::multiplies<int8_t>>("mulsb"));
    rootInst.SetInst(0x31, new BinaryOpInst<uint8_t, std::multiplies<uint8_t>>("mulby"));
    rootInst.SetInst(0x32, new BinaryOpInst<int16_t, std::multiplies<int16_t>>("mulsh"));
    rootInst.SetInst(0x33, new BinaryOpInst<uint16_t, std::multiplies<uint16_t>>("mulus"));
    rootInst.SetInst(0x34, new BinaryOpInst<int32_t, std::multiplies<int32_t>>("mulin"));
    rootInst.SetInst(0x35, new BinaryOpInst<uint32_t, std::multiplies<uint32_t>>("mului"));
    rootInst.SetInst(0x36, new BinaryOpInst<int64_t, std::multiplies<int64_t>>("mullo"));
    rootInst.SetInst(0x37, new BinaryOpInst<uint64_t, std::multiplies<uint64_t>>("mulul"));
    rootInst.SetInst(0x38, new BinaryOpInst<float, std::multiplies<float>>("mulfl"));
    rootInst.SetInst(0x39, new BinaryOpInst<double, std::multiplies<double>>("muldo"));

    //  divide:
    rootInst.SetInst(0x3A, new BinaryOpInst<int8_t, std::divides<int8_t>>("divsb"));
    rootInst.SetInst(0x3B, new BinaryOpInst<uint8_t, std::divides<uint8_t>>("divby"));
    rootInst.SetInst(0x3C, new BinaryOpInst<int16_t, std::divides<int16_t>>("divsh"));
    rootInst.SetInst(0x3D, new BinaryOpInst<uint16_t, std::divides<uint16_t>>("divus"));
    rootInst.SetInst(0x3E, new BinaryOpInst<int32_t, std::divides<int32_t>>("divin"));
    rootInst.SetInst(0x3F, new BinaryOpInst<uint32_t, std::divides<uint32_t>>("divui"));
    rootInst.SetInst(0x40, new BinaryOpInst<int64_t, std::divides<int64_t>>("divlo"));
    rootInst.SetInst(0x41, new BinaryOpInst<uint64_t, std::divides<uint64_t>>("divul"));
    rootInst.SetInst(0x42, new BinaryOpInst<float, std::divides<float>>("divfl"));
    rootInst.SetInst(0x43, new BinaryOpInst<double, std::divides<double>>("divdo"));

    //  remainder:
    rootInst.SetInst(0x44, new BinaryOpInst<int8_t, std::modulus<int8_t>>("remsb"));
    rootInst.SetInst(0x45, new BinaryOpInst<uint8_t, std::modulus<uint8_t>>("remby"));
    rootInst.SetInst(0x46, new BinaryOpInst<int16_t, std::modulus<int16_t>>("remsh"));
    rootInst.SetInst(0x47, new BinaryOpInst<uint16_t, std::modulus<uint16_t>>("remus"));
    rootInst.SetInst(0x48, new BinaryOpInst<int32_t, std::modulus<int32_t>>("remin"));
    rootInst.SetInst(0x49, new BinaryOpInst<uint32_t, std::modulus<uint32_t>>("remui"));
    rootInst.SetInst(0x4A, new BinaryOpInst<int64_t, std::modulus<int64_t>>("remlo"));
    rootInst.SetInst(0x4B, new BinaryOpInst<uint64_t, std::modulus<uint64_t>>("remul"));

    //  bitwise and:
    rootInst.SetInst(0x4C, new BinaryOpInst<int8_t, std::bit_and<int8_t>>("andsb"));
    rootInst.SetInst(0x4D, new BinaryOpInst<uint8_t, std::bit_and<uint8_t>>("andby"));
    rootInst.SetInst(0x4E, new BinaryOpInst<int16_t, std::bit_and<int16_t>>("andsh"));
    rootInst.SetInst(0x4F, new BinaryOpInst<uint16_t, std::bit_and<uint16_t>>("andus"));
    rootInst.SetInst(0x50, new BinaryOpInst<int32_t, std::bit_and<int32_t>>("andin"));
    rootInst.SetInst(0x51, new BinaryOpInst<uint32_t, std::bit_and<uint32_t>>("andui"));
    rootInst.SetInst(0x52, new BinaryOpInst<int64_t, std::bit_and<int64_t>>("andlo"));
    rootInst.SetInst(0x53, new BinaryOpInst<uint64_t, std::bit_and<uint64_t>>("andul"));

    //  bitwise or:
    rootInst.SetInst(0x54, new BinaryOpInst<int8_t, std::bit_or<int8_t>>("orsb"));
    rootInst.SetInst(0x55, new BinaryOpInst<uint8_t, std::bit_or<uint8_t>>("orby"));
    rootInst.SetInst(0x56, new BinaryOpInst<int16_t, std::bit_or<int16_t>>("orsh"));
    rootInst.SetInst(0x57, new BinaryOpInst<uint16_t, std::bit_or<uint16_t>>("orus"));
    rootInst.SetInst(0x58, new BinaryOpInst<int32_t, std::bit_or<int32_t>>("orin"));
    rootInst.SetInst(0x59, new BinaryOpInst<uint32_t, std::bit_or<uint32_t>>("orui"));
    rootInst.SetInst(0x5A, new BinaryOpInst<int64_t, std::bit_or<int64_t>>("orlo"));
    rootInst.SetInst(0x5B, new BinaryOpInst<uint64_t, std::bit_or<uint64_t>>("orul"));

    //  bitwise xor:
    rootInst.SetInst(0x5C, new BinaryOpInst<int8_t, std::bit_xor<int8_t>>("xorsb"));
    rootInst.SetInst(0x5D, new BinaryOpInst<uint8_t, std::bit_xor<uint8_t>>("xorby"));
    rootInst.SetInst(0x5E, new BinaryOpInst<int16_t, std::bit_xor<int16_t>>("xorsh"));
    rootInst.SetInst(0x5F, new BinaryOpInst<uint16_t, std::bit_xor<uint16_t>>("xorus"));
    rootInst.SetInst(0x60, new BinaryOpInst<int32_t, std::bit_xor<int32_t>>("xorin"));
    rootInst.SetInst(0x61, new BinaryOpInst<uint32_t, std::bit_xor<uint32_t>>("xorui"));
    rootInst.SetInst(0x62, new BinaryOpInst<int64_t, std::bit_xor<int64_t>>("xorlo"));
    rootInst.SetInst(0x63, new BinaryOpInst<uint64_t, std::bit_xor<uint64_t>>("xorul"));

    //  shift left:
    rootInst.SetInst(0x64, new BinaryOpInst<int8_t, ShiftLeft<int8_t>>("shlsb"));
    rootInst.SetInst(0x65, new BinaryOpInst<uint8_t, ShiftLeft<uint8_t>>("shlby"));
    rootInst.SetInst(0x66, new BinaryOpInst<int16_t, ShiftLeft<int16_t>>("shlsh"));
    rootInst.SetInst(0x67, new BinaryOpInst<uint16_t, ShiftLeft<uint16_t>>("shlus"));
    rootInst.SetInst(0x68, new BinaryOpInst<int32_t, ShiftLeft<int32_t>>("shlin"));
    rootInst.SetInst(0x69, new BinaryOpInst<uint32_t, ShiftLeft<uint32_t>>("shlui"));
    rootInst.SetInst(0x6A, new BinaryOpInst<int64_t, ShiftLeft<int64_t>>("shllo"));
    rootInst.SetInst(0x6B, new BinaryOpInst<uint64_t, ShiftLeft<uint64_t>>("shlul"));

    //  shift right:
    rootInst.SetInst(0x6C, new BinaryOpInst<int8_t, ShiftRight<int8_t>>("shrsb"));
    rootInst.SetInst(0x6D, new BinaryOpInst<uint8_t, ShiftRight<uint8_t>>("shrby"));
    rootInst.SetInst(0x6E, new BinaryOpInst<int16_t, ShiftRight<int16_t>>("shrsh"));
    rootInst.SetInst(0x6F, new BinaryOpInst<uint16_t, ShiftRight<uint16_t>>("shrus"));
    rootInst.SetInst(0x70, new BinaryOpInst<int32_t, ShiftRight<int32_t>>("shrin"));
    rootInst.SetInst(0x71, new BinaryOpInst<uint32_t, ShiftRight<uint32_t>>("shrui"));
    rootInst.SetInst(0x72, new BinaryOpInst<int64_t, ShiftRight<int64_t>>("shlro"));
    rootInst.SetInst(0x73, new BinaryOpInst<uint64_t, ShiftRight<uint64_t>>("shrul"));

    // comparisons:
    // ------------

    //  equal:
    rootInst.SetInst(0x74, new BinaryPredInst<int8_t, std::equal_to<int8_t>>("equalb"));
    rootInst.SetInst(0x75, new BinaryPredInst<uint8_t, std::equal_to<uint8_t>>("equalby"));
    rootInst.SetInst(0x76, new BinaryPredInst<int16_t, std::equal_to<int16_t>>("equalsh"));
    rootInst.SetInst(0x77, new BinaryPredInst<uint16_t, std::equal_to<uint16_t>>("equalus"));
    rootInst.SetInst(0x78, new BinaryPredInst<int32_t, std::equal_to<int32_t>>("equalin"));
    rootInst.SetInst(0x79, new BinaryPredInst<uint32_t, std::equal_to<uint32_t>>("equalui"));
    rootInst.SetInst(0x7A, new BinaryPredInst<int64_t, std::equal_to<int64_t>>("equallo"));
    rootInst.SetInst(0x7B, new BinaryPredInst<uint64_t, std::equal_to<uint64_t>>("equalul"));
    rootInst.SetInst(0x7C, new BinaryPredInst<float, std::equal_to<float>>("equalfl"));
    rootInst.SetInst(0x7D, new BinaryPredInst<double, std::equal_to<double>>("equaldo"));
    rootInst.SetInst(0x7E, new BinaryPredInst<char, std::equal_to<char>>("equalch"));
    rootInst.SetInst(0x7F, new BinaryPredInst<char16_t, std::equal_to<char16_t>>("equalwc"));
    rootInst.SetInst(0x80, new BinaryPredInst<char32_t, std::equal_to<char32_t>>("equaluc"));
    rootInst.SetInst(0x81, new BinaryPredInst<bool, std::equal_to<bool>>("equalbo"));

    //  less:
    rootInst.SetInst(0x82, new BinaryPredInst<int8_t, std::less<int8_t>>("lesssb"));
    rootInst.SetInst(0x83, new BinaryPredInst<uint8_t, std::less<uint8_t>>("lessby"));
    rootInst.SetInst(0x84, new BinaryPredInst<int16_t, std::less<int16_t>>("lesssh"));
    rootInst.SetInst(0x85, new BinaryPredInst<uint16_t, std::less<uint16_t>>("lessus"));
    rootInst.SetInst(0x86, new BinaryPredInst<int32_t, std::less<int32_t>>("lessin"));
    rootInst.SetInst(0x87, new BinaryPredInst<uint32_t, std::less<uint32_t>>("lessui"));
    rootInst.SetInst(0x88, new BinaryPredInst<int64_t, std::less<int64_t>>("lesslo"));
    rootInst.SetInst(0x89, new BinaryPredInst<uint64_t, std::less<uint64_t>>("lessul"));
    rootInst.SetInst(0x8A, new BinaryPredInst<float, std::less<float>>("lessfl"));
    rootInst.SetInst(0x8B, new BinaryPredInst<double, std::less<double>>("lessdo"));
    rootInst.SetInst(0x8C, new BinaryPredInst<char, std::equal_to<char>>("lessch"));
    rootInst.SetInst(0x8D, new BinaryPredInst<char16_t, std::equal_to<char16_t>>("lesswc"));
    rootInst.SetInst(0x8E, new BinaryPredInst<char32_t, std::equal_to<char32_t>>("lessuc"));
    rootInst.SetInst(0x8F, new BinaryPredInst<bool, std::equal_to<bool>>("lessbo"));
    ...
    //  -----------------------------
    GroupInst* convGroupInst = new GroupInst(*this, "<conv_group_instruction>");
...
Instruction* Machine::GetInst(const std::string& instName) const
{
