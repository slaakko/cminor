...
void CreateBasicTypeObjectFun(Assembly& assembly, ClassTypeSymbol* objectType, TypeSymbol* boolType)
{
    ConstantPool& constantPool = assembly.GetConstantPool();
    ...
    defaultInit->SetType(objectType);
    ...
    returnFun->SetType(objectType);
    returnFun->SetReturnType(objectType);
