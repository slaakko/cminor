...
ActionParser::ActionParser(const std::u32string& name_, cminor::codedom::CompoundStatement* successCode_, Parser* child_): 
    UnaryParser(name_, child_, child_->Info()), successCode(successCode_), failCode(), action(), failureAction() 
{
}

ActionParser::ActionParser(const std::u32string& name_, cminor::codedom::CompoundStatement* successCode_, cminor::codedom::CompoundStatement* failCode_, 
