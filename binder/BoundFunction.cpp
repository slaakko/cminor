...
BoundFunction::BoundFunction(FunctionSymbol* functionSymbol_) : 
    BoundNode(*functionSymbol_->GetAssembly()), functionSymbol(functionSymbol_), nextTempVarNumber(0), hasGotos(false), containerScope(nullptr)
{
}
