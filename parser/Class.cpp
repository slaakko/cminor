...
void ClassGrammar::GetReferencedGrammars()
{
    ...
    cminor::parsing::Grammar* grammar1 = pd->GetGrammar("cminor.parser.EnumerationGrammar");
    if (!grammar1)
    {
    ...
    cminor::parsing::Grammar* grammar4 = pd->GetGrammar("cminor.parser.ExpressionGrammar");
    if (!grammar4)
    {
