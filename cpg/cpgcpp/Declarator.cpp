...
public:
    ...
    void PostInitDeclarator(cminor::parsing::ObjectStack& stack, bool matched)
    {
        if (matched)
        {
...
public:
    ...
    void PostInitializerClause(cminor::parsing::ObjectStack& stack, bool matched)
    {
        if (matched)
        {
...
public:
    ...
    void PreInitializerList(cminor::parsing::ObjectStack& stack)
    {
        stack.push(std::unique_ptr<cminor::parsing::Object>(new cminor::parsing::ValueObject<cminor::pom::AssignInit*>(context.value)));
    }
private:
            ...
            new cminor::parsing::AlternativeParser(
                ...
                new cminor::parsing::SequenceParser(
                    new cminor::parsing::SequenceParser(
                        ...
                        new cminor::parsing::NonterminalParser("AbstractDeclarator", "AbstractDeclarator", 0)),
                    new cminor::parsing::CharParser(')'))))));
    AddRule(new cminor::parsing::Rule("PtrOperator", GetScope(),
        new cminor::parsing::AlternativeParser(
            new cminor::parsing::SequenceParser(
                new cminor::parsing::CharParser('*'),
                new cminor::parsing::OptionalParser(
