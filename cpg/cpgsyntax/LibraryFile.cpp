...
{
public:
    LibraryFileRule(const std::string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
...
void LibraryFileGrammar::CreateRules()
{
    ...
    AddRule(new LibraryFileRule("LibraryFile", GetScope(), GetParsingDomain()->GetNextRuleId(),
