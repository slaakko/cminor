...
void XmlProcessor::EndStartTag(const cminor::parsing::Span& span, const std::string& systemId)
{
...
void XmlProcessor::EndTag(const std::u32string& tagName, const cminor::parsing::Span& span, const std::string& systemId)
{
    if (tagStack.empty())
    {
...
void XmlProcessor::AddAttribute(const std::u32string& attName, const std::u32string& attValue, const cminor::parsing::Span& span, const std::string& systemId)
{
    std::u32string localName;
    std::u32string prefix;
...
void XmlProcessor::EntityRef(const std::u32string& entityName, const cminor::parsing::Span& span, const std::string& systemId)
{
...
std::u32string XmlProcessor::GetNamespaceUri(const std::u32string& namespacePrefix, const cminor::parsing::Span& span, const std::string& systemId)
{
...
void XmlProcessor::ParseQualifiedName(const std::u32string& qualifiedName, std::u32string& localName, std::u32string& prefix, const cminor::parsing::Span& span, const std::string& systemId)
{
...
std::string XmlProcessor::GetErrorLocationStr(const std::string& systemId, const cminor::parsing::Span& span) const
{
